...
class FavoritesModelFavoritessh extends JModelList{
	...
	public function &getData(){
		// Load the data
		if (empty( $this->_data )) {
			$query = 'SELECT * FROM `#__virtuemart_favorites_sh` WHERE `shared_id` = '.$this->_id;
...
// mcm code 
		$data['shared_id'] = JRequest::getVar('id', '', 'post', 'int');
		$data['isWishList'] = JRequest::getVar('isWishList', '', 'post', 'int');
// mcm code 
