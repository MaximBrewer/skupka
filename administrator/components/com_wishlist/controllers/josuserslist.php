 ...
 */
class FavoritesControllerJosuserslist extends FavoritesController{
	...
	public function edit(){
		...
		$view =& $this->getView('josusers', 'html');
	...
	public function save(){
		$model = $this->getModel('josuserslist'); 
	...
	public function publish(){
		...
		$this->setRedirect( 'index.php?option=com_wishlist&controller=josuserslist' );
	}
	...
	function cancel() {
		$model = $this->getModel( 'josusers' );
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_wishlist&view=josuserslist' );
	}
	*/
