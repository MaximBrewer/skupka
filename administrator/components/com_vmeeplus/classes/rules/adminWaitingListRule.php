...
class emp_rules_adminWaitingListRule extends emp_rules_base{
	public function getTrigger(){
		return 'TRIGGER_ADMIN_WAITING_LIST';
	}

	public function getTriggerDisplayName(){
		return JText::_('TRIGGER_ADMIN_WAITING_LIST');
	}
	...
	public function isSendEmails(){
		return !emp_helper::getGlobalParam('is_disable_admin_waiting_list');
	}
