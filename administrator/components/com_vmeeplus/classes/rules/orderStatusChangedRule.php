...
class emp_rules_orderStatusChangedRule extends emp_rules_base{
	public function getTrigger(){
		return 'TRIGGER_ORDER_STATUS_CHANGED';
	}

	public function getTriggerDisplayName(){
		return JText::_('TRIGGER_ORDER_STATUS_CHANGED');
	}
	...
	public function isSendEmails(){
		return !emp_helper::getGlobalParam('is_disable_order_status');
	}
}