...
class emp_conditionPlugins_CompleteOrdersCount extends emp_conditionPlugins_base{
	...
	public function getDisplayName(){
		return JText::_( 'COMPLETE_ORDERS_COUNT' );
	}
	...
	public function evaluateCondition($operator, $value, $args, & $errors){
		...
		$ordersCount = $this->getCompleteOrdersCount($userId);
	...
	public function getDescription(){
		return JText::_( 'COMPLETE_ORDERS_COUNT_CONDITION_DESCRIPTION' );
	}
