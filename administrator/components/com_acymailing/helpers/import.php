...
class acyimportHelper{
	...
	function joomla(){
		$query = 'UPDATE IGNORE '.acymailing_table($this->cmsUserVars->table, false).' as b, '.acymailing_table('subscriber').' as a SET a.email = b.'.$this->cmsUserVars->email.', a.name = b.'.$this->cmsUserVars->name.', a.enabled = 1 - b.'.$this->cmsUserVars->blocked.' WHERE a.userid = b.'.$this->cmsUserVars->id.' AND a.userid > 0';
