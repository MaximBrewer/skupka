...
?><div id="acy_content">
	...
	<form action="<?php echo acymailing_completeLink('autonews'); ?>" method="post" name="adminForm" id="adminForm" autocomplete="off" enctype="multipart/form-data">
		...
		<div style="float: left; width: 60%;">
			...
			<div class="acyblockoptions acyblock_newsletter" id="textfieldset">
				...
				<textarea style="width:98%" rows="20" name="data[mail][altbody]" id="altbody" onClick="zoneToTag='altbody';"><?php echo @$this->mail->altbody; ?></textarea>
			</div>
		</div>
