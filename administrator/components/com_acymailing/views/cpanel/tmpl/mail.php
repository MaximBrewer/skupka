		...
		<div id="mailer_method_config">
			...
			<div id="elasticemail_config" style="display:none" class="acymailing_deploy">
				...
				<table class="acymailing_table" cellspacing="1">
					<tr>
						<td width="185" class="acykey">
							<label for="elasticemail_username"><?php echo acymailing_translation('ACY_USERNAME'); ?></label>
						</td>
						<td>
							<input id="elasticemail_username" class="inputbox" autocomplete="off" type="text" name="config[elasticemail_username]" style="width:160px" value="<?php echo $this->config->get('elasticemail_username', '') ?>"/>
						</td>
					</tr>
					<tr>
						<td width="185" class="acykey">
							<label for="elasticemail_password">API Key</label>
						</td>
						<td>
							<input id="elasticemail_password" class="inputbox" autocomplete="off" type="text" name="config[elasticemail_password]" style="width:160px" value="<?php echo str_repeat('*', strlen($this->config->get('elasticemail_password'))); ?>"/>
						</td>
					</tr>
					<tr>
						<td width="185" class="acykey">
							<label for="elasticemail_poolname"><?php echo acymailing_tooltip('This option only works when using the REST API', '', '', 'IP Pool name (optional)'); ?></label>
						</td>
						<td>
							<input id="elasticemail_poolname" class="inputbox" autocomplete="off" type="text" name="config[elasticemail_poolname]" style="width:160px" value="<?php echo $this->config->get('elasticemail_poolname', '') ?>"/>
						</td>
					</tr>
					<tr>
						<td width="185" class="acykey">
