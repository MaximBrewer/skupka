...
class Numbers_Words
{
    ...
    function toCurrency($num, $locale = 'en_US', $int_curr = '')
    {
        ...
        if (!in_array('toCurrencyWords', $methods) && !in_array('tocurrencywords', $methods)) {
        	...
        	return $this->toWords($num, $locale); //added: ARTIO: fallback 
    ...
    function getLocales($locale = null)
    {
        ...
        $dname = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'numbers' . DIRECTORY_SEPARATOR . 'words' . DIRECTORY_SEPARATOR;
    ...
    {
    	JError::raiseWarning(0, $msg); //EDITED: ARTIO
    	return false;
    	/*
