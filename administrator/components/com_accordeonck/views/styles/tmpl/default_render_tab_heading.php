...
<div class="ckrow">
	...
	<input type="text" id="headingstylesfontfamily" name="headingstylesfontfamily" class="headingstyles hasTip" onchange="ckCleanGfontName(this)" title="<?php echo JText::_('CK_GFONT_DESC'); ?>" />
