...
class AccordeonckViewItems extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// JFactory::getApplication()->redirect('index.php?option=com_accordeonck&view=items&format=raw&menutype='.JFactory::getApplication()->input->get('menutype'));
		$lang 		= JFactory::getLanguage();
		$this->items	= $this->get('Items');
		require_once(JPATH_ADMINISTRATOR . '/components/com_accordeonck/models/moduleselect.php');
//		$modules = new AccordeonckModelModuleselect();
		$modules = JModelLegacy::getInstance('Moduleselect', 'AccordeonckModel');
