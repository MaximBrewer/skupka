...
<script src="<?php echo JUri::root(true) ?>/administrator/components/com_accordeonck/assets/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo JUri::root(true) ?>/administrator/components/com_accordeonck/assets/jquery-noconflict.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo JUri::root(true) ?>/modules/mod_accordeonck/assets/font-awesome.min.css" type="text/css" />
<link rel="stylesheet" href="<?php echo JUri::root(true) ?>/administrator/components/com_accordeonck/assets/bootstrap.min.css" type="text/css" />
...
<div class="container-fluid">
	...
	<div style="position: relative; height: 46px; display: block;" class="">
		...
		<span class="btn-group">
			<button class="btn fa fa-search" id="filter-submit" onclick="searchiconsck()"></button>
			<button class="btn fa fa-times" id="filter-clear" onclick="clearsearchiconsck()"></button>
		</span>
	</div>
	<div>
		<h3><?php echo JText::_('CK_FILTER_BY_GROUP') ?></h3>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('web-application')">Web Application Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('transportation')">Transportation Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('gender')">Gender Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('file-type')">File Type Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('spinner')">Spinner Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('form-control')">Form Control Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('payment')">Payment Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('chart')">Chart Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('currency')">Currency Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('text-editor')">Text Editor Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('directional')">Directional Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('video-player')">Video Player Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('brand')">Brand Icons</button>
		<button class="btn filter-category" id="filter-submit" onclick="filtericonsbycatck('medical')">Medical Icons</button>
	</div>
</div>
<script>
...
jQuery(document).ready(function() {
	jQuery('.fa-hover a').click(function(e) {
		e.preventDefault();
		window.parent.select_fa_icon(jQuery(this).find('i').attr('class'));
