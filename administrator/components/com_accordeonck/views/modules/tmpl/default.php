...
<form action="<?php echo JRoute::_('index.php?option=com_accordeonck'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped" id="templateckList">
        ...
        <tbody>
			...
			foreach ($this->items as $i => $item) :
				...
				$canCheckin = $user->authorise('core.manage', 'com_accordeonck');
				$canChange = $user->authorise('core.edit.state', 'com_accordeonck');
				$link = 'index.php?option=com_accordeonck&view=styles&id=' . $item->id;
				?>
