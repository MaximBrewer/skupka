...
/**
 * Methods supporting a list of Accordeonck records.
 */
class AccordeonckModelModules extends JModelList {

	protected $_context		= 'com_accordeonck.modules';
	...
	protected function getListQuery()
	{
		...
		$query->select('e.name AS name')
			...
			->group(
				'a.id, a.title, a.note, a.position, a.module, a.language,a.checked_out,' .
					'a.checked_out_time, a.published, a.access, a.ordering,l.title, ag.title, e.name,' .
					'l.lang_code, ag.id, mm.moduleid, e.element, a.publish_up, a.publish_down,e.enabled'
			);
		...
		// }
		// Filter only the maximenu module
		$query->where('a.module = ' . $db->quote('mod_accordeonck'));
