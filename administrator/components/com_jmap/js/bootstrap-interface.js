...
jQuery(function($) {
	...
	var defaultAccordionObject = {'accordion_cpanel':'seo_stats',
							      ...
							      'jmap_googlestats_webmasters_crawl_errors_accordion':['jmap_googlestats_webmasters_crawl_errors'],
							      'jmap_googlestats_webmasters_crawl_errors_notfound_accordion':['jmap_googlestats_webmasters_crawl_errors_notfound'],
							      'jmap_googlestats_webmasters_crawl_errors_servererrors_accordion':['jmap_googlestats_webmasters_crawl_errors_servererrors'],
							      'jmap_googlestats_webmasters_crawl_errors_soft404_accordion':['jmap_googlestats_webmasters_crawl_errors_soft404'],
							      'jmap_googlestats_webmasters_crawl_errors_noauth_accordion':['jmap_googlestats_webmasters_crawl_errors_noauth'],
							      'jmap_googlestats_webmasters_crawl_errors_other_accordion':['jmap_googlestats_webmasters_crawl_errors_other'],
