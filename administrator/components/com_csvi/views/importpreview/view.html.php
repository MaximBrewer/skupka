...
/**
 * Import show the preview view.
 *
 * @package     CSVI
 * @subpackage  Imports
 * @since       6.0
 */
class CsviViewImportpreview extends JViewLegacy
{
	/**
	 * The sidebar to show
	 *
	...
	private function toolbar()
	{
		...
		JToolBarHelper::custom('import.start', 'play', 'play', JText::_('COM_CSVI_START_IMPORT'), false);
	}
}
