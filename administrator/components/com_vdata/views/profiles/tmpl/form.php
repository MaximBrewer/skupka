...
<div class="col100">
	<fieldset class="adminform">
		<?php $pf = ($this->item->id>0) ? JText::_('EDIT_PROFILE') : JText::_('NEW_PROFILE'); ?>
		<legend><?php echo JText::_('PROFILE').' : '.$pf; ?></legend>
<table class="adminform table table-striped">
<tr>
    <td width="200"><label class="required hasTip" title="<?php echo JText::_('PROFILE_TITLE_DESC');?>"><?php echo JText::_('TITLE'); ?></label></td>
