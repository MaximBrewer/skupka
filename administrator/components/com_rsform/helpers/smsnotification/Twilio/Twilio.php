                ...
                $_http = new Services_Twilio_TinyHttp(
                    ...
                    array(
                        "curlopts" => array(
                            ...
                            CURLOPT_SSL_VERIFYHOST => (bool) RSFormProHelper::getConfig('smsnotification.usessl'),
                            CURLOPT_SSL_VERIFYPEER => (bool) RSFormProHelper::getConfig('smsnotification.usessl'),
                        ),
                    )
                );
            } else {
                $_http = new Services_Twilio_HttpStream(
                    ...
                    array(
                        "http_options" => array(
                            ...
                            "ssl" => array(
                                'verify_peer' => (bool) RSFormProHelper::getConfig('smsnotification.usessl'),
                                'verify_depth' => 5,
                            ),
                        ),
                    )
