...
// 			vmdebug('createLanguageTables ',$translatableFields);
			...
			if(VmConfig::get('dblayoutstrict',true)){
				if($table=='products'){
//-					$fields['product_s_desc'] = 'varchar('.VmConfig::get('dbpsdescsize',2000).') '.$linedefault; // *!* 2017-05-01, 2016-07-08, 2016-06-30
//-					$fields['product_desc'] = 'varchar('.VmConfig::get('dbpdescsize',18400).') '.$linedefault; // *!* 2017-05-01, 2016-07-08, 2016-06-30
					$fields['product_s_desc'] = 'mediumtext '.$linedefaulttext; // *!* 2017-05-01, 2016-07-08, 2016-06-30
					$fields['product_desc'] = 'mediumtext '.$linedefaulttext; // *!* 2017-05-01, 2016-07-08, 2016-06-30
