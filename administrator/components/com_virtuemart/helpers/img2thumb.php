	...
	private function NewImgSave($new_img,$fileout,$type)
	{
		...
		switch($type)
		{
			case "gif":
				...
				break;
			case "jpeg": // *!* 2016-07-07 Another's
			case "jpg":
//-				if (strtolower(substr($fileout,strlen($fileout)-4,4))!=".jpg") // *!* 2016-07-07 Another's
				if (strtolower(substr($fileout,strlen($fileout)-4,4))!=".jpg" && strtolower(substr($fileout,strlen($fileout)-9,9))!=".jpeg.jpg") // *!* 2016-07-07
					$fileout .= ".jpg";
					if (strtolower(substr($fileout,strlen($fileout)-9,9))==".jpeg.jpg")
$fileout = preg_replace('/\.jpg$/i','',$fileout); // *!* 2016-07-07
