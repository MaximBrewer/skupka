...
class VmMediaHandler {
	...
	function setFileInfo($type=0){
		...
		/*if(!empty($this->file_url) && empty($this->file_url_thumb)){
 		...
 		// *!* 2016-07-20 Begin. Problem with thumbnails uploading
		if(!empty($this->file_url) && empty($this->file_url_thumb)){ // *!* 2016-07-20 Problem with thumbnails uploading
			$this->displayMediaThumb('',true,'',true);
		} // *!* 2016-07-20 Problem with thumbnails uploading
		// *!* 2016-07-20 End. Problem with thumbnails uploading
