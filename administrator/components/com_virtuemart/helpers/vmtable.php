...
//-			$unicodeslugs = VmConfig::get('transliterateSlugs',false); // *!* 2016-07-07 Another's
			$unicodeslugs = VmConfig::get('transliterateSlugs',true); // *!* 2016-07-07 Another's
			if($unicodeslugs){
			...
			$this->$slugName = str_replace(array(',','.'),'-',$this->$slugName); // *!* 2016-07-07 Another's
			$this->$slugName = str_replace(array('ъ','Ъ'),'',$this->$slugName); // *!* 2016-07-07 Another's
