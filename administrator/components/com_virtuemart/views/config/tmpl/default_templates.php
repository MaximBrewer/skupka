...
<fieldset>
	...
	<table class="admintable">
		...
		echo VmHTML::row('checkbox','COM_VIRTUEMART_ADMIN_CFG_SHOW_RND_PROD','show_random', VmConfig::get('show_random',1));
		echo VmHTML::row('input','COM_VIRTUEMART_ADMIN_CFG_RND_PROD_ROWS','random_products_rows', VmConfig::get('random_products_rows',1),'',4,4); // *!* 2016-11-04 Begin. Random Products on Home page of VM
		?>
	</table>
</fieldset>
<fieldset>
