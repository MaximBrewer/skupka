...
* @version $Id: default.php 9221 2016-05-23 11:34:36Z Milbo $
*/
...
//-					echo shopFunctionsF::limitStringByWord($cat->category_description,200); 
					echo shopFunctionsF::limitStringByWord(strip_tags($cat->category_description),200); // *!* 2016-07-20 Removes HTML and PHP-tags from a string category description
?>
				</td>
				<td>
