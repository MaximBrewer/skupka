...
<table class="adminlist table" style="table-layout: fixed;">
	<tr>
		...
		<td valign="top">
		<table class="adminlist table" style="display:none;">
			<thead>
				<tr>
	...
	<tr>
		...
		foreach ($this->orderdetails['items'] as $item) { ?>
			...
			<tr valign="top" <?php echo $lId?>><?php /*id="showItem_<?php echo $item->virtuemart_order_item_id; ?>" data-itemid="<?php echo $item->virtuemart_order_item_id; ?>">*/ ?>
				<?php $new_zero_line = $item->virtuemart_order_item_id; // *!* 2016-07-08 Add's positions in Order ?>
				<!--<td>
		...
		<?php } ?>
			<tr id="updateOrderItemStatus">
					...
					<td colspan="5">
						...
						&nbsp;&nbsp;
						<a href="#" onClick="javascript:addNewLine(event,<?php echo /*- $this->orderdetails['items'][0]->virtuemart_order_item_id */ $new_zero_line // *!* 2016-07-08 Add's positions in Order ?>);"><span class="icon-nofloat vmicon vmicon-16-new"></span><?php echo '&nbsp;'. vmText::_('JTOOLBAR_NEW'); ?></a>
					</td>
