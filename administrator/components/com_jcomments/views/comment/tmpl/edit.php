				...
				<div class="span6">
					...
					<div class="control-group">
						...
						<div class="controls">
	                        ...
	                        <?php echo editor('jform[comment]',  $this->form->getValue('comment'), '80%;', '270', '70', '20', array('pagebreak', 'readmore') ) ; ?>
						</div>
					</div>
...
<?php
	function editor($name,$value,$size='100%',$height='300',$hide = array('pagebreak', 'readmore')){
