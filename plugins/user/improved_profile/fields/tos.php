...
class JFormFieldTos extends JFormFieldRadio
{
	...
	protected function getLabel()
	{
		...
		$css = "fieldset.radio {margin: 0; padding: 0 2px;}
		...
		$link = '<a class="modal" title="" href="'.JURI::root().'index.php?option=com_content&amp;view=article&amp;layout=modal&amp;id=' . $tosarticle . '&amp;tmpl=component" rel="{handler: \'iframe\', size: {x:800, y:500}}">' . $text . '</a>';
