/*!
 * Social Locker - v1.7.9, 2015-07-30 
 ...
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";a.onepress||(a.onepress={}),a.onepress.sdk||(a.onepress.sdk={}),a.onepress.sdk.linkedin=a.onepress.sdk.linkedin||{name:"linkedin",url:"//platform.linkedin.com/in.js",scriptId:"linkedin-jssdk",timeout:1e4,isLoaded:function(){return"object"==typeof window.IN},prepare:function(){window.onepressLinkedInShareCallback=function(b){a(document).trigger("onp-sl-linkedin-share",[b])};var b=window.open;window.open=function(c,d,e){console.log(d);var f=b(c,d,e);if(!f)return f;var g=d||f.name;return g?"easyXDM_IN"!==g.substring(0,10)?f:void(a.onepress.sdk.linkedin._activePopup=f):f}}}}(jQuery);;
/*!
 * Youtube Subscribe
 * Copyright 2013, OnePress, http://byonepress.com
*/
!function(a){"use strict";a.onepress.sociallocker.google||(a.onepress.sociallocker.google={}),a.onepress.sociallocker.google.youtube={_idx:0,getVerificationData:function(){return{container:".onp-button-loaded",timeout:15e3}},create:function(b,c,d){var e={googleClientOAuth:!1,_defaults:{clientId:null,channelId:null,layout:"default",counter:1},_create:function(){var b=this;return a.onepress.sociallocker.google.youtube._idx++,this._idx=a.onepress.sociallocker.google.youtube._idx,this._prepareOptions(),b.options.clientId?this.options.channelId?(this._createButton(),this._setupEvents(),this._youtubeApiConnect(),void a.onepress.connector.connect("googleClient",this.options,function(){})):void d.setButtonError(b.element,a.onepress.sociallocker.lang.youtubeChannelIdMissed):void d.setButtonError(b.element,a.onepress.sociallocker.lang.googleClientIdMissed)},_prepareOptions:function(){var b=a.extend({},this._defaults);this.options=a.extend(b,this.options),this.url=URL.normalize(this.options.url||window.location.href),this.scopes="https://www.googleapis.com/auth/youtube"},_setupEvents:function(){var b=this;a(document).bind("google-client-script-loaded",function(){gapi.auth.init(function(){window.setTimeout(function(){b._checkAuthorize()},1)})}),b.pseudoYoutubeButton.on("click",function(){return b.googleClientOAuth?void b._authorize(!1,function(a){b._subscribe(a)}):void b._subscribe()}),a(document).bind("youtube-finish-subscribe",function(){b.options.unlock("button")}),window["getYoutubeChannelSubscribers_"+b._idx]=function(a){var c=a.entry.yt$statistics.subscriberCount;c||(c=0),b.youtubeButtonCounter.text(b._minimalizeLongInt(c))}},_authorize:function(a,b){var c=this;gapi.auth.authorize({client_id:c.options.clientId,scope:c.scopes,immediate:a},b)},_checkAuthorize:function(){var a=this;this._authorize(!0,function(b){a._handleResult(b)})},_handleResult:function(a){var b=this;return b._unlockLoadingState(),"immediate_failed"===a.error?void(b.googleClientOAuth=!0):void 0},_subscribe:function(){var b=this;gapi.client.load("youtube","v3",function(){var c=gapi.client.youtube.subscriptions.insert({part:"snippet",resource:{snippet:{resourceId:{kind:"youtube#channel",channelId:b.options.channelId}}}});c.execute(function(b){b.error&&"subscriptionDuplicate"!=b.error.data[0].reason||a(document).trigger("youtube-finish-subscribe")})})},_unlockLoadingState:function(){this.button.addClass("onp-button-loaded")},_youtubeApiConnect:function(){a.getScript("https://gdata.youtube.com/feeds/api/users/"+this.options.channelId+"?alt=json-in-script&callback=getYoutubeChannelSubscribers_"+this._idx+"&v=2")},_minimalizeLongInt:function(a){return a>999?"999+":a},_createButton:function(){this.button=a("<div></div>"),this.wrap=a("<div class='onp-social-button onp-youtube-button onp-youtube-subscribe-button'></div>").appendTo(this.element).append(this.button),this.pseudoYoutubeButton=a('<div class="onp-pseudo-youtube-subscribe-button"><i class="onp-youtube-btn-icon"></i> Youtube</div>'),this.youtubeButtonCounter=a('<div class="onp-youtube-subscribe-counter"></div>'),this.button.append(this.pseudoYoutubeButton),this.button.append(this.youtubeButtonCounter),this.options.counter&&this.youtubeButtonCounter.css("display","inline-block")}};return e.element=b,e.options=c,e._create(),e}}}(jQuery);;
/*!
 * Google Client SDK
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";a.onepress||(a.onepress={}),a.onepress.sdk||(a.onepress.sdk={}),a.onepress.sdk.googleClient=a.onepress.sdk.googleClient||{name:"googleClient",url:"//apis.google.com/js/client:platform.js?onload=OnpSL_GoogleClient_Callback",scriptId:"google-client-jssdk",timeout:1e4,isLoaded:function(){return window.gapi&&"object"==typeof window.gapi.auth},prepare:function(){window.OnpSL_GoogleClient_Callback=function(){a(document).trigger("google-client-script-loaded")}}}}(jQuery);;
/*!
