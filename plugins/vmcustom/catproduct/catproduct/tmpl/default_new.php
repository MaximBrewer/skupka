...
?>
    ...
    <h1>121212121</h1>
    <form  ax:nowrap="1" action="index.php" method="post" name="catproduct_form" id="catproduct_form" onsubmit="handleToCartOneByOne(); return false;">
        <table style="width:100%;" class="catproducttable">
			...
			jQuery("a[rel=catproduct_images_'.$i.']").facebox();});';
					...
					<input class="quantity-controls quantity-minus" onclick=\'changeQuantity('.$i.', "minus", '.$min_order_level.', '.$max_order_level.', '.$product_box .')\' type="button"></span>';
                                        ?>
                                        <input type="submit" name="addtocart" class="addtocart-button 2222222" value="<?php echo JText::_('CATPRODUCT_ADDTOCART') ?>" title="<?php echo JText::_('CATPRODUCT_ADDTOCART') ?>">
                                        <?php
                                        echo '</td>';
                                    } else {
