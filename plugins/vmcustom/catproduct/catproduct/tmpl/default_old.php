...
<tr>
	...
	if ($parametri["show_name"] == 1) { ?>
        ...
        <th>Кол-во на поддоне / в коробке</th>
	<?php $colspan += 2;}
...
// Product sizes
        ...
        //	******************************************
		//дописуем 	Кол-во на поддоне / в коробке start
          ?>
          <td class="cell_customfields" style="text-align: center;">
              <?php
              echo $product['child']["product_box"];
              ?>
          </td>
         <?php
        //  дописуем 	Кол-во на поддоне / в коробке end
        //**********************************************
  ...
  <input type="submit" name="addtocart" class="addtocart-button 33333333" value="<?php echo JText::_('CATPRODUCT_ADDTOCART') ?>" title="<?php echo JText::_('CATPRODUCT_ADDTOCART') ?>">
</span>
		</td>
		</tr>
		<?php } ?>
