...
<?php if ($guest): // LOGIN ?>
  ...
  <?php if (@$module->view != 'reg'): ?>
    ...
    <?php
        ...
        $logTmpl = ($myp[0] == "community") ? "/cbLog25.php" : "/log25.php";
    ...
    <?php if ($loginpopup): ?>
      ...
      <a class="logBtn selectBtn" onclick="return false" href="<?php echo JRoute::_('index.php?option=com_users&view=login') ?>">
        ...
        <?php else: ?>
          ...
          <span class="loginBtn1"><?php echo JText::_('JLOGIN') ?></span>
  ...
  <?php endif ?>
    ...
    <?php elseif ($allowReg != 'hide'): ?>
  	  ...
  	  <a class="regBtn1 selectBtn <?php if (!$loginpopup) echo 'fullWidth' ?>" href="<?php echo $regpage ?>">
      ...
      <?php else: ?>
        ...
        <span class="loginBtn1"><?php echo JText::_(@$module->view == 'log' || !$loginpopup? 'MOD_LOGIN_REGISTER':'JREGISTER') ?></span>
