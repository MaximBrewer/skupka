			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
				<div class="spacer">
                    ...
                    <div class="wmvo_sravnit">
                        ...
                        ?>
                        <span data-id="<?= $product->virtuemart_product_id ?>"  class="btn-compare fa fa-random <?= $cl ?> compa<?= $product->virtuemart_product_id ?>" data-link="/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=<?php echo $product->virtuemart_product_id; ?>&compare=1&tack=add"></span>
                    </div>
                    <!-- добавить в сравнение -->
                    <!--быстрая покупка -->
                    <div class="wmvo_bistraj_pokypka">
                        ...
                        <a data-link="<?php echo $link_;?>" data-name="<?=$product->product_name ?>"  class="tovar_zakaz" href="index.php?option=com_rsform&formId=12&tmpl=component">купить в 1 клик</a>
                    </div>
                    <!--быстрая покупка end -->
