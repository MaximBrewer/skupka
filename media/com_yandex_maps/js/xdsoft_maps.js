/**
 * @copyright    Copyright (c) 2014 XDSoft (https://xdan.ru) chupurnov@gmail.com. All rights reserved.
...
!function ($) {
    ...
    ymaps.ready(function () {
        ...
        var
            ...
            behaviors = ['scrollZoom', 'drag', 'dblClickZoom', 'multiTouch', 'rightMouseButtonMagnifier', 'ruler'],
            r;
            ...
            if (e.get('domEvent').get('which') === 1) {
                ...
                switch (object_type) {
                    ...
                    case 'circle':
                        ...
                        var x = proj.fromGlobalPixels([300, 0], map.getZoom()),
    ...
    var timeoutupdate = 0;
    var _opt = {
        options: ['strokeColor', 'strokeOpacity', 'strokeWidth', 'fillColor', 'fillOpacity', 'preset'],
    ...
    function updateObject(object) {
        ...
        timeoutupdate = setTimeout(function () {
            ...
            $.post('/modules/mod_xdsoft_ymaps/ajax_input.php', {
                ...
                type: object_type,
                module_id: module_id,
                id: parseInt(object.options.get('xdsoft_id')),
