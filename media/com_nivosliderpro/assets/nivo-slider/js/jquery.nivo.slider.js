...
(function($) {
    var NivoSlider = function(element, options) {
        ...
        if (settings.controlNav) {
            ...
            //control with BG        	
            if (settings.controlBG == true) {
                var controlWrapper = $('<div class="nivo-controlNav"></div>');
                slider.append(controlWrapper);
                controlWrapper.append('<div class="nivo-controlNavLeft"></div>');

                var nivoControl = $('<div class="nivo-controlNavMiddle"></div>');
                controlWrapper.append(nivoControl);

                controlWrapper.append('<div class="nivo-controlNavRight"></div>');

            } else {	//control without bg
...
//            }
            if (settings.controlNav) {
                $('a', '.nivo-controlNav').removeClass('active');
                $('.nivo-controlNav a:eq(' + vars.currentSlide + ')', slider).addClass('active');
            }
            // Process caption
            processCaption(settings);
