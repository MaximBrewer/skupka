...
<p>
	<span>
		<input placeholder="Имя" id="comments-form-name" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<p>
	<span>
		<input placeholder="Email" id="comments-form-email" type="text" name="email" value="" size="22" tabindex="2" />
...
<p>
	<span>
		<textarea placeholder="Текст сообщения" id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5"></textarea>
	</span>
</p>
<?php
