...
<input value="1" type="checkbox" id="agreed_field" name="tosAccepted" <?php if (!empty($agree_checked)) echo ' checked="checked" '; ?> class="terms-of-service"  required="required" autocomplete="off" /></div>
					<div class="agreed_label_wrapper"><label for="agreed_field"><span class="label_text"><?php echo OPCLang::_('COM_VIRTUEMART_I_AGREE_TO_TOS'); ?></span><br /><?php
					if (!empty($tos_link))
...
<!-- end show TOS and checkbox before button -->
 ...
 <div id="confirmbtn_area">
	<button id="confirmbtn_button" type="submit" autocomplete="off" <?php echo $op_onclick; ?> ><span class="op_round"><span id="confirmbtn" class="inspan" style="width: 250px;"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_CONFIRM_MNU') ?></span></span></span></button>
 </div>
<br style="clear: both;"/>
</div>
