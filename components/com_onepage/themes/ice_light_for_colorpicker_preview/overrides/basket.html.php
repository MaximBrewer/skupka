...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10%" class="korzina_wapka_1">Фото</td>
    <td width="40%" class="korzina_wapka_2">Наименование товара</td>
    <td width="20%" align="center" class="korzina_wapka_2">Цена</td>
    <td width="20%" align="center" class="korzina_wapka_2">Количесво</td>
    <td width="10%" align="right" class="korzina_wapka_3">Сумма</td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="10%" height="40" class="korzina_tovar_1"><?php echo $this->op_show_image($product['product_full_image'], '', 50, 50, 'product'); ?></td>
    <td width="40%" class="korzina_tovar_2"><div class="korzina_otstup_tovar_artikyl"><?php echo $product['product_name'] . $product['product_attributes'] ?></div>      <?php echo $product['product_sku'] ?></td>
    <td width="20%" align="center" class="korzina_tovar_2"><?php echo $basePrice; ?>&nbsp;<?php echo $discount; ?></td>
    <td width="20%" align="center" class="korzina_tovar_2"> <?php echo $product['update_form'] ?>
		<?php echo $product['delete_form']; 
		?></td>
    <td width="10%" align="right" class="korzina_tovar_3"><?php echo $product['subtotal'];?></td>
  </tr>
</table>
