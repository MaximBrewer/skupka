...
$show_login_first = false; 
if (!empty($config->show_login_first))
	$show_login_first = true; 
...
<div id="coupon_and_html" <?php if ($show_login_first) echo ' style="display: none;" '; ?>>
<?php
...
<form action="<?php echo $action_url; ?>" method="post" name="adminForm" class="for2m-va2lidate" novalidate>
...
<div class="opc_customer" id="opc_customer_registration" <?php if ($show_login_first) echo ' style="display: none;" '; ?> >
...
?>
<div class="opc_login" id="opc_login_section" style="<?php if (!$show_login_first) echo ' display: none; '; ?>">
	<div id="logintab">
...
<div id="opc_shipping_and_shipto_section" <?php if ($show_login_first) echo ' style="display: none;" '; ?>>
<div class="opc_section" <?php if ($no_shipping || ($shipping_inside_basket) || ($show_login_first)) echo 'style="display: none;"'; ?> id="opc_shipping_section">
<?php 
...
<!-- end shipping address info -->
<div class="opc_section" id="opc_payment_section" <?php if ($show_login_first) echo ' style="display: none;" '; ?> >
...
?>
<div class="opc_section opc_very_bottom" id="opc_bottom_section" <?php if ($show_login_first) echo ' style="display: none;" '; ?> >
<!-- end payment method -->


<?php
	
if(($show_full_tos) || ($tos_required) || ($italian_checkbox))
{
?>
...
<div id="submit_section" <?php if ($show_login_first) echo ' style="display: none;" '; ?>>
<div class="opc_section" id="opc_tos_section" style="width: 100%; <?php if ($show_login_first) echo ' display: none; '; ?>">
    <div class="inline_block">
							<!-- shipping methodd -->
							<?php if (!empty($show_full_tos)) { ?>
								<?php echo $tos_con; ?>
								<br style="clear: both;"/>
								<!-- end shipping methodd -->
							<?php } ?>
								
								<div class="checkboxes_tos">
...
?>
   <div class="field_wrapper2"  style="width: 100%;">
	<div id="agreed_div" class="formLabel3 " style="text-align: left; white-space: normal; width: 5%; float: left;">
...
<input value="1" type="checkbox" id="agreed_field" name="tosAccepted" <?php if (!empty($agree_checked)) echo ' checked="checked" '; ?> class="terms-of-service"  required="required" autocomplete="off" />
	...
	<div style="width: 95%; float:left;">
					<label for="agreed_field" style="white-space: normal;"><span class="agree_text"><?php echo OPCLang::_('Согласен на обработку персональных данных ').'</span>';  
					if (!empty($tos_link))
					{
