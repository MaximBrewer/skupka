...
$opc_async = false; 
    ...
    $opc_acymailing_checkbox = false; 
     ...
     $opc_memory = '256M';  $rupostel_email = ''; $opc_plugin_order = '-9999';
    ...
    $klarna_se_get_address = false;$ajaxify_cart = true;$opc_check_email = false;$opc_no_duplicit_email = false; 
    $show_single_tax = true;
    $opc_calc_cache = false; 
    $visitor_shopper_group = "2";
...
$email_after = false;
      $opc_link_type = 0;
       $business_fields = array();  $custom_rendering_fields = array();  $per_order_rendering = array('customer_note');  $opc_ajax_fields = array('address_1');  $admin_shopper_fields = array();  $render_as_hidden = array();  $render_in_third_address = array();  $html5_fields = array();  $html5_fields_extra = array();  $html5_placeholder = array();  $html5_validation_error = array();  $shipping_obligatory_fields = array();  $business_obligatory_fields = array(); $op_disable_shipping = false;
      $op_disable_shipto = true;
 ...
 $opc_usmode = false;  $full_tos_logged = false;  $tos_scrollable = false;  $full_tos_unlogged = false;  $tos_logged = false;  $tos_unlogged = true;  $opc_email_in_bt = true;  $double_email = false;  $coupon_price_display = "salesPriceCoupon";
 $other_discount_display = "billDiscountAmount";
$agreed_notchecked = false;
...
$cut_login = false;
	  ...
	  $selected_template = OPCmini::getSelectedTemplate('sandwitch_german', 'sandwitch_german'); 
	  

		
       
  $is_mobile = false; 
  $mobile_template = "sandwitch_german";   $adwords_timeout = 4; $dont_show_inclship = false;
