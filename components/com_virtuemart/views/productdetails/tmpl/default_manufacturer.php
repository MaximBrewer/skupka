...
<div class="manufacturer">
	...
	foreach($this->product->manufacturers as $manufacturers_details) {
		...
		//Link to products
		$link = JRoute::_('index.php?option=com_virtuemart&view=category&virtuemart_manufacturer_id=' . $manufacturers_details->virtuemart_manufacturer_id. '&tmpl=component', FALSE);
