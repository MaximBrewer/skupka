...
?>
<table class="html-email" width="100%" cellspacing="0" cellpadding="3" border="0">
    <tr align="left" class="sectiontableheader">
        
        <td align="left" colspan="2">
            <strong><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_NAME_TITLE') ?></strong></td>

        <?php if ($this->doctype == 'invoice') { ?>
            <td align="right" width="10%"><strong><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRICE') ?></strong>
            </td>
        <?php } ?>
        <td align="right" width="12%"><strong><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_QTY') ?></strong></td>
        <?php if ($this->doctype == 'invoice') { ?>
            <?php if (VmConfig::get('show_tax')) { ?>
                <td align="right" width="4%"><strong><?php
            ...
            <td align="right" width="11%"><strong><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></strong>
            </td>
        <?php } ?>
    </tr>
    ...
    foreach ($this->orderDetails['items'] as $item) {
        ...
        <tr valign="top">
            ...
            <td align="left" colspan="2">
                <div float="right"><a href="<?php echo $product_link; ?>"><?php echo $item->order_item_name; ?></a>
                </div>
                <?php
                ...
                <?php
                //sku
                if (strlen($item->order_item_sku) > 1) {
            ...
            <?php if ($this->doctype == 'invoice') { ?>
                <td align="right" class="priceCol">
                    ...
                    $sk=$item->product_priceWithoutTax -$item->product_discountedPriceWithoutTax;
                    if (!empty($item->product_priceWithoutTax) && $item->product_discountedPriceWithoutTax != $item->product_priceWithoutTax) {
                        ...
                        echo '<span >-' . $this->currency->priceDisplay($sk, $this->user_currency_id) . '</span><br />';
            ...
            <?php if ($this->doctype == 'invoice') { ?>
                <?php if (VmConfig::get('show_tax')) { ?>
                    ...
                    ?>
                    <td align="right"
                        class="priceCol"><?php echo "<span  class='priceColor2'>" . $this->currency->priceDisplay($item->product_tax, $this->user_currency_id, $qtt) . "</span>" ?></td>
                <?php } ?>
                <td align="right" class="priceCol">
                ...
                <td align="right" class="priceCol">
                    ...
                    if ($item->product_subtotal_discount!=="0.00000") {
                    	echo $this->currency->priceDisplay($item->product_subtotal_discount, $this->user_currency_id).'<br />';
    ...
    <?php if ($this->doctype == 'invoice') { ?>
        <tr>
            <td width="19%" colspan="<?php echo $colspan ?>"></td>
        </tr>
        ...
        if ($this->orderDetails['details']['BT']->coupon_discount <> 0.00) {
            ...
            ?>
            <tr>
                <td align="right" class="pricePad"
                    colspan="6"><?php echo vmText::_('COM_VIRTUEMART_COUPON_DISCOUNT') . $coupon_code ?></td>
                <?php if (VmConfig::get('show_tax')) { ?>
                    <td align="right"></td>
                <?php } ?>
                <td align="right"></td>
                <td width="3%" align="right"><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->coupon_discount, $this->user_currency_id); ?></td>
            </tr>
        ...
        if (!empty($this->orderDetails['details']['BT']->payment_currency_rate)
            ...
            <td align="right" class="pricePad" colspan="7">
                <strong><?php echo vmText::_('COM_VM_TOTAL_IN_PAYMENT_CURRENCY') ?></strong></td>
        ...
        if ($taxBill) {
            ...
            <td colspan="7" align="right"
                class="pricePad"><?php echo vmText::_('COM_VIRTUEMART_TOTAL_INCL_TAX') ?> </td>
            <td></td>
            <td></td>
            </tr><?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td><?php echo $this->orderDetails['shipmentName'] ?></td>
        <td><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_shipment + $this->orderDetails['details']['BT']->order_shipment_tax, $this->user_currency_id); ?></td>
    </tr>
    <tr>
        <td><?php echo $this->orderDetails['paymentName'] ?></td>
        <td><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_payment + $this->orderDetails['details']['BT']->order_payment_tax, $this->user_currency_id); ?></td>
    </tr>
    <tr>
        <td><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></td>
        <td><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total, $this->user_currency_id); ?></td>
    </tr>
</table>
