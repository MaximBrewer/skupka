 ...
 * @version $Id: view.html.php 9249 2016-06-30 10:46:30Z Milbo $
 */
...
class VirtueMartViewVirtueMart extends VmView {
	...
	public function display($tpl = null) {
		...
		if(!VmConfig::get('shop_is_offline',0)){
			...
			// *!* 2016-11-04 Begin. Random Products on Home page of VM
			$random_products_rows = VmConfig::get('random_products_rows');
			$random_products_count = $products_per_row * $random_products_rows;

			if (!empty($random_products_count) and VmConfig::get('show_random', 1)) {
				$this->products['random']= $productModel->getProductListing('random', $random_products_count);
				$productModel->addImages($this->products['random'],1);
			}
			// *!* 2016-11-04 End. Random Products on Home page of VM
