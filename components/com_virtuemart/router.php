...
//-			if ( isset($query['virtuemart_manufacturer_id'])  ) { // *!* 2016-07-08, 2015-11-20			
			if ( isset($query['virtuemart_manufacturer_id']) AND !isset($query['showproducts']) ) { // *!* 2016-07-08, 2015-11-20
			...
			// *!* 2016-07-08, 2015-11-20 Begin
			} elseif ( 1 === (int)$query['showproducts'] ) {
				$segments[] = $helper->getManufacturerName($query['virtuemart_manufacturer_id']) ;
			} elseif ( 2 === (int)$query['showproducts'] ) {
				$segments[] = $helper->getManufacturerName($query['virtuemart_manufacturer_id']).'/'.$helper->lang('manufacturer').'/'.$helper->getManufacturerName($query['virtuemart_manufacturer_id']) ;
			// *!* 2016-07-08, 2015-11-20 End
			}
...
//-			if ( isset($jmenu['category']) ) $query['Itemid'] = $jmenu['category']; // *!* 2016-07-08, 2016-01-19
...
//		$cache = JFactory::getCache('_virtuemart',''); // *!* 2016-07-08, 2015-05-19
		$cache = JFactory::getCache('com_virtuemart_cats',''); // *!* 2016-07-08, 2015-05-19
		$cache->clean(); // *!* 2016-07-08, 2015-05-19
