...
//				FavoritesModelFavoriteslist::addtocart($product, JText::_('COM_VIRTUEMART_CART_ADD_TO'),$product_ord);
			   ...
			   echo shopFunctionsF::renderVmSubLayout('stockhandle',array('product'=>$product));
                ...
                <div class="tovar_zakaz_v_klik">
                    ...
                    <a data-link="<?php echo $link_;?>" data-name="<?=$this->product->product_name ?>"  class="tovar_zakaz" href="index.php?option=com_rsform&formId=22&tmpl=component">Купить в 1 клик</a>
                </div>
