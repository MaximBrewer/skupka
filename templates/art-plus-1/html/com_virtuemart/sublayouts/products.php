  ...
  <div class="<?php echo $type ?>-view">
   ...
   <div class="main-image">
                                        <a title="<?php echo $product->product_name ?>"
                                           href="<?php
                                           //echo $product->link;
                                           echo  JRoute::_ ( 'index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id , FALSE);
                                           ?>">
                                            <?php
...
<div class="wmvo_nazvanie_kategoria"><div class="wmvo_nazvanie_kategoria_2"><?php
//                                       echo JHtml::link($product->link . $ItemidStr, $product->product_name);
//                                       echo JHtml::link($product->link . $ItemidStr, $product->product_name);
                                       echo JHtml::link ( JRoute::_ ( 'index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id , FALSE), $product->product_name );
                                       ?></div></div>
             <div class="ma_kat">
...
//-				echo shopFunctionsF::renderVmSubLayout('addtocart',array('product'=>$product,)); // 
				...
				echo shopFunctionsF::renderVmSubLayout('addtocart',array('product'=>$product,'rowHeights'=>$rowsHeight[$row], 'position' => array('wer','ontop', 'addtocart'))); // 
			...
			?>
                 ...
                 <div class="wmvo_sravnit">
                  ...
                  <div class="wmvo_bistraj_pokypka"> <?php $link_=JURI::base().JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id='.$product->virtuemart_product_id.'&virtuemart_category_id='.$product->virtuemart_category_id); ?>
                      ...
                      <a data-link="<?php echo $link_;?>" data-name="<?=$product->product_name ?>"  class="tovar_zakaz" href="index.php?option=com_rsform&formId=22&tmpl=component">Купить<br>в
1 клик</a></div>
                  <div class="wishlist">
