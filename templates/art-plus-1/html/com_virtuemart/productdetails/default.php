...
?>
	...
	echo $this->product->event->beforeDisplayContent; ?>
      ...
      <div class="tovar_right_bloc">
        ...
        <div class="ma_kat">
          <?php echo $this->product->mf_name; ?>&nbsp;\&nbsp;<?php echo $this->product->category_name ?>
  </div>
        <div class="product_sku">Артикул: <?php echo $this->product->product_sku ?></div>
        <div class="kratkoe_opisanie_v_tovare"><?php echo $this->product->product_s_desc ?></div>
        
        
        <div class="wmvo_bistraj_pokypka"> 
          <?php
         // если количество больше нуля то выводим быстрый заказ
         if (($this->product->product_in_stock - $this->product->product_ordered) >0) {
      ?>
          <div class="wmvo_bistraj_pokypka">
            <?php
                 jimport( 'joomla.application.module.helper' );
                 $module = JModuleHelper::getModules('position-38');
                 $attribs['style'] = 'xhtml';
...
?>
  ...
  <script type="text/javascript" src="share42/share42.js"></script>
		...
		if (VmConfig::get('show_manufacturers', 1) && !empty($this->product->virtuemart_manufacturer_id)) {
		    ...
		    echo '<span class="product-sku_1">'.JText::_('Производитель') .':</span> '. $this->loadTemplate('manufacturer');
		}
		?>
        </div>
...
<script src="/modules/mod_virtuemart_wishlist_products/js/wishlist_products.js"></script>
