	...
	<?php foreach ($this->children[$this->category->id] as $id => $child) : ?>
		...
		<?php if (in_array($child->access, $groups)) : ?>
			...
			<div<?php echo $class; ?>>
				...
				<?php else : ?>
				<?php if ($child->getParams()->get('image')) : //если есть картинка у подкатегории?>
         <div class="item-pic"><a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id));?>">
            <img src="<?php echo $child->getParams()->get('image'); //вывод картинки?>"/>
            </a>
         </div>
         <?php endif; ?>
