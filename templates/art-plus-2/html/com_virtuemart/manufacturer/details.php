...
//-	$manufacturerProductsURL = JRoute::_('index.php?option=com_virtuemart&view=category&virtuemart_manufacturer_id=' . $this->manufacturer->virtuemart_manufacturer_id, FALSE); // *!* 2015-11-20
	$manufacturerProductsURL = JRoute::_('index.php?option=com_virtuemart&view=category&showproducts=2&virtuemart_manufacturer_id=' . $this->manufacturer->virtuemart_manufacturer_id, FALSE); // *!* 2015-11-20
