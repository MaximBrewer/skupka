...
//		$manufacturerURL = JRoute::_('index.php?option=com_virtuemart&view=manufacturer&virtuemart_manufacturer_id=' . $manufacturer->virtuemart_manufacturer_id, FALSE); // *!* 2016-01-28
//		$manufacturerURL = JRoute::_('index.php?option=com_virtuemart&view=category&layout=manufacturer&virtuemart_manufacturer_id=' . $manufacturer->virtuemart_manufacturer_id . '&showcategories=0&showdescription=1&showproducts=1', FALSE); // *!* 2016-01-28
		$manufacturerURL = JRoute::_('index.php?option=com_virtuemart&view=category&virtuemart_manufacturer_id=' . $manufacturer->virtuemart_manufacturer_id . '&showproducts=1', FALSE); // *!* 2016-01-28
...
<div class="kategoria_o">
      <div class="izobrajenie"><a title="<?php echo $manufacturer->mf_name; ?>" href="<?php echo $manufacturerURL; ?>"><?php echo $manufacturerImage;?></a></div>
      <div class="nazvanie"> <a title="<?php echo $manufacturer->mf_name; ?>" href="<?php echo $manufacturerURL; ?>"><?php echo $manufacturer->mf_name; ?></a>
