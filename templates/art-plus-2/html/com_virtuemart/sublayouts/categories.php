...
// Start the Output
  ...
  <div class="row">
    ...
    <div class="kategoria_o">
      <div class="izobrajenie"><a href="<?php echo $caturl ?>" title="<?php echo vmText::_($category->category_name) ?>">
        <?php // if ($category->ids) {
            echo $category->images[0]->displayMediaThumb("",false);
          //} ?>
      </a></div>
      <div class="nazvanie"> <a href="<?php echo $caturl ?>" title="<?php echo vmText::_($category->category_name) ?>">
