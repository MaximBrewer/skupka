	...
	if ($display_style == "div") {
		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
                ...
                <div class="virmod_otstyp">
                  <div class="virmod_vnewnaa_granica">
                    <div class="virmod_izobrajenie"><?php
                    ...
                    <div class="virmod_nazvanie"> <a href="<?php echo $url ?>"><?php echo $product->product_name ?></a></div>
